...
const BUILTIN = [
  ...
  { name: "undo", title: "撤销", desc: "回到更早一轮，同 rewind", group: "session" },
  ...
  { name: "cost", title: "费用", desc: "查看额度与账单", group: "system" },
  ...
  { name: "status", title: "会话状态", desc: "认证、模型、轮次、上下文", group: "system" },
