...
const BUILTIN = [
  ...
  { name: "context", title: "上下文用量", desc: "上下文窗口与会话统计", desktop: true, group: "session" },
  { name: "session-info", title: "会话信息", desc: "模型、轮次、上下文用量", desktop: true, group: "session" },
  ...
  // Account / system
  { name: "usage", title: "额度用量", desc: "查看额度与账单", desktop: true, group: "system" },
  ...
  { name: "docs", title: "文档", desc: "打开文档", desktop: true, group: "system" },
  { name: "release-notes", title: "更新说明", desc: "查看版本说明", group: "system" },
  { name: "help", title: "帮助", desc: "帮助与配置说明", desktop: true, group: "system" },
