...
(function (global) {
  const STRINGS = {
    zh: {
      ...
      "chat.goal": "目标",
      "chat.goalTitle": "执行目标",
      "chat.goalEmpty": "尚无目标步骤。助手进入目标模式后会出现在这里。",
      "chat.goalHint": "打开 / 关闭右侧目标面板",
      "chat.subagent": "子代理",
      "chat.subagentTitle": "子代理",
      "chat.subagentEmpty": "还没有子代理。助手开了子代理会出现在这里。",
      "chat.subagentHint": "打开 / 关闭右侧子代理面板",
      "chat.subagentClose": "关闭子代理面板",
      "chat.callHint": "派给另一个对话，做完交回本会话审计",
      "chat.ready": "就绪",
      "chat.send": "发送",
      "chat.stop": "停止",
      "chat.effort": "强度",
      ...
      "page.memory.emptyExpOff": "经验记忆已关闭。此页仍可管理，对话里不会自动用经验。",
      ...
      "page.skills.howtoBody": "每个 Skill 是一份 SKILL.md。这里可以浏览、改正文并调用。",
      "page.plugins.title": "插件",
      "page.plugins.desc": "装官方 marketplace 或 git 插件。MCP 在设置 → MCP",
      ...
      "settings.profileLead": "当前账号，以及对话里显示的昵称和头像",
      "usage.dailyTitle": "每天消耗",
      "usage.dailyLead": "按上海时区统计本机对话用量，不是周限额",
      "usage.sum": "累计 Token",
      "usage.peak": "单日峰值",
      "usage.today": "今天",
      ...
      "usage.tabWeek": "每周",
      "usage.tabAll": "累计",
      "settings.profileAccount": "当前账号",
      "settings.profileLogin": "登录状态",
      "settings.profileEmail": "邮箱",
      "settings.profileName": "账号名",
      "settings.profilePlan": "套餐",
      "settings.profileChat": "对话展示",
      "settings.profileNick": "昵称",
      "settings.profileNickDesc": "对话里现在写的「你」",
      "settings.profileAvatar": "头像",
      "settings.profileAvatarDesc": "有头像时你用头像，Grok 用官方 logo",
      ...
      "settings.appearanceLead": "主题、配色、界面密度、聊天背景",
      "settings.theme": "界面主题",
      ...
      "settings.palette": "配色",
      "settings.paletteDesc": "点一下立刻换，浅色和深色各有一套",
      "settings.palette.paper": "暖纸",
      "settings.palette.stone": "冷灰",
      "settings.palette.ink": "墨白",
      "settings.palette.sage": "茶青",
      "settings.palette.dusk": "暮蓝",
      "settings.palette.clay": "陶土",
    ...
    en: {
      ...
      "chat.goal": "Goal",
      "chat.goalTitle": "Goal",
      "chat.goalEmpty": "No goal steps yet. They appear when the agent enters goal mode.",
      "chat.goalHint": "Toggle the goal panel",
      "chat.subagent": "Subagents",
      "chat.subagentTitle": "Subagents",
      "chat.subagentEmpty": "No subagents yet. They show up here when the assistant launches them.",
      "chat.subagentHint": "Open / close the subagent panel",
      "chat.subagentClose": "Close the subagent panel",
      "chat.callHint": "Send a task to another chat; results come back here",
      "chat.ready": "Ready",
      "chat.send": "Send ↑",
      "chat.stop": "Stop",
      "chat.effort": "Effort",
      ...
      "slash.empty": "Enter to send this slash",
      "slash.badgeSkill": "Skill",
      ...
      "settings.profileLead": "Account, plus the nickname and avatar shown in chat",
      "usage.dailyTitle": "Daily usage",
      "usage.dailyLead": "Tokens used on this machine, Shanghai time, not the weekly quota",
      "usage.sum": "Total tokens",
      "usage.peak": "Busiest day",
      "usage.today": "Today",
      "usage.activity": "Token activity",
      "usage.tabDay": "Daily",
      "usage.tabWeek": "Weekly",
      "usage.tabAll": "Total",
      "settings.profileAccount": "Account",
      "settings.profileLogin": "Sign-in",
      "settings.profileEmail": "Email",
      "settings.profileName": "Name",
      "settings.profilePlan": "Plan",
      "settings.profileChat": "In chat",
      "settings.profileNick": "Nickname",
      "settings.profileNickDesc": "Replaces “You” on your messages",
      "settings.profileAvatar": "Avatar",
      "settings.profileAvatarDesc": "If set, your messages use the photo and Grok uses its logo",
      ...
      "settings.appearanceLead": "Theme, palette, density, and chat background",
      ...
      "settings.paletteDesc": "Applies immediately — each has a light and dark set",
      "settings.palette.paper": "Paper",
      "settings.palette.stone": "Stone",
      "settings.palette.ink": "Ink",
      "settings.palette.sage": "Sage",
      "settings.palette.dusk": "Dusk",
      "settings.palette.clay": "Clay",
